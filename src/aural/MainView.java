...
public class MainView extends BorderPane
{
    ...
    protected static MainView instance = null;
    ...
    public static MainView getInstance() throws ControllerNotFoundException
    {
        if (instance == null)
            throw new ControllerNotFoundException("Controller Not Found and not given");
        return instance;
    }
    ...
    public boolean changeView(ViewType vType, Object view)
    {
        if (vType == ViewType.MAIN)
        {
            setCenter(centerBox);
            return true;
        } else if (vType == ViewType.KEYMAP)
        {
            setCenter(new KeyMapView(new KeyMapController()));
            return true;
        } else if (vType == ViewType.PREFERENCES)
        {
            setCenter(new PreferencesView(new PreferencesViewController()));
            return true;
        }
